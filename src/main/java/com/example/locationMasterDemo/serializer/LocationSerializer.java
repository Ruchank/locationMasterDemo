package com.example.locationMasterDemo.serializer;
...
@Slf4j
public class LocationSerializer extends JsonSerializer<Json> {
    Logger log = LoggerFactory.getLogger(LocationSerializer.class);
